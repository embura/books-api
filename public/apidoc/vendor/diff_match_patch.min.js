(function () {
  ...
  diff_match_patch.prototype.diff_main = function (a, b, c, d) {
    typeof d === 'undefined' && (d = this.Diff_Timeout <= 0 ? Number.MAX_VALUE : (new Date()).getTime() + 1E3 * this.Diff_Timeout); if (a == null || b == null) throw Error('Null input. (diff_main)'); if (a == b) return a ? [[0, a]] : []; typeof c === 'undefined' && (c = !0); var e = c,
      f = this.diff_commonPrefix(a, b); c = a.substring(0, f); a = a.substring(f); b = b.substring(f); var f = this.diff_commonSuffix(a, b),
        g = a.substring(a.length - f); a = a.substring(0, a.length - f); b = b.substring(0, b.length - f); a = this.diff_compute_(a,
b, e, d); c && a.unshift([0, c]); g && a.push([0, g]); this.diff_cleanupMerge(a); return a;
  };
  diff_match_patch.prototype.diff_compute_ = function (a, b, c, d) {
    if (!a) return [[1, b]]; if (!b) return [[-1, a]]; let e = a.length > b.length ? a : b,
      f = a.length > b.length ? b : a,
      g = e.indexOf(f); return g != -1 ? (c = [[1, e.substring(0, g)], [0, f], [1, e.substring(g + f.length)]], a.length > b.length && (c[0][0] = c[2][0] = -1), c) : f.length == 1 ? [[-1, a], [1, b]] : (e = this.diff_halfMatch_(a, b)) ? (f = e[0], a = e[1], g = e[2], b = e[3], e = e[4], f = this.diff_main(f, g, c, d), c = this.diff_main(a, b, c, d), f.concat([[0, e]], c)) : c && a.length > 100 && b.length > 100 ? this.diff_lineMode_(a, b,
  ...
  diff_match_patch.prototype.diff_bisect_ = function (a, b, c) {
    for (var d = a.length, e = b.length, f = Math.ceil((d + e) / 2), g = f, h = 2 * f, j = Array(h), i = Array(h), k = 0; k < h; k++)j[k] = -1, i[k] = -1; j[g + 1] = 0; i[g + 1] = 0; for (var k = d - e, q = k % 2 != 0, r = 0, t = 0, p = 0, w = 0, v = 0; v < f && !((new Date()).getTime() > c); v++) {
      for (var n = -v + r; n <= v - t; n += 2) {
        var l = g + n,
          m; m = n == -v || n != v && j[l - 1] < j[l + 1] ? j[l + 1] : j[l - 1] + 1; for (var s = m - n; m < d && s < e && a.charAt(m) == b.charAt(s);)m++, s++; j[l] = m; if (m > d)t += 2; else if (s > e)r += 2; else if (q && (l = g + k - n, l >= 0 && l < h && i[l] != -1)) {
            var u = d - i[l]; if (m >=
u) return this.diff_bisectSplit_(a, b, m, s, c);
  ...
  diff_match_patch.prototype.diff_commonOverlap_ = function (a, b) {
    var c = a.length,
      d = b.length; if (c == 0 || d == 0) return 0; c > d ? a = a.substring(c - d) : c < d && (b = b.substring(0, c)); c = Math.min(c, d); if (a == b) return c; for (var d = 0, e = 1; ;) {
        var f = a.substring(c - e),
          f = b.indexOf(f); if (f == -1) return d; e += f; if (f == 0 || a.substring(c - e) == b.substring(0, e))d = e, e++;
      }
  };
  diff_match_patch.prototype.diff_halfMatch_ = function (a, b) {
    function c(a, b, c) {
      for (var d = a.substring(c, c + Math.floor(a.length / 4)), e = -1, g = '', h, j, n, l; (e = b.indexOf(d, e + 1)) != -1;) {
        let m = f.diff_commonPrefix(a.substring(c), b.substring(e)),
          s = f.diff_commonSuffix(a.substring(0, c), b.substring(0, e)); g.length < s + m && (g = b.substring(e - s, e) + b.substring(e, e + m), h = a.substring(0, c - s), j = a.substring(c + m), n = b.substring(0, e - s), l = b.substring(e + m));
      } return 2 * g.length >= a.length ? [h, j, n, l, g] : null;
    } if (this.Diff_Timeout <= 0) return null;
    var d = a.length > b.length ? a : b,
      e = a.length > b.length ? b : a; if (d.length < 4 || 2 * e.length < d.length) return null; var f = this,
        g = c(d, e, Math.ceil(d.length / 4)),
        d = c(d, e, Math.ceil(d.length / 2)),
        h; if (!g && !d) return null; h = d ? g ? g[4].length > d[4].length ? g : d : d : g; let j; a.length > b.length ? (g = h[0], d = h[1], e = h[2], j = h[3]) : (e = h[0], j = h[1], g = h[2], d = h[3]); h = h[4]; return [g, d, e, j, h];
  };
  ...
  diff_match_patch.prototype.diff_cleanupSemanticLossless = function (a) {
    function b(a, b) {
      if (!a || !b) return 6; var c = a.charAt(a.length - 1),
        d = b.charAt(0),
      ...
      if (a[c - 1][0] == 0 && a[c + 1][0] == 0) {
        var d = a[c - 1][1],
          e = a[c][1],
          f = a[c + 1][1],
          g = this.diff_commonSuffix(d, e); if (g) {
            ...
            var d = d + e.charAt(0),
              ...
              f = f.substring(1),
              k = b(d, e) + b(e, f); k >= i && (i = k, g = d, h = e, j = f);
...
g), e = e.substring(0, e.length - g))), c === 0 ? a.splice(b - d, c + d, [1, f]) : d === 0 ? a.splice(b - c, c + d, [-1, e]) : a.splice(b - c - d, c + d, [-1, e], [1, f]), b = b - c - d + (c ? 1 : 0) + (d ? 1 : 0) + 1) : b !== 0 && a[b - 1][0] == 0 ? (a[b - 1][1] += a[b][1], a.splice(b, 1)) : b++, c = d = 0, f = e = '';
      }
    }a[a.length - 1][1] === '' && a.pop(); c = !1; for (b = 1; b < a.length - 1;) {
      a[b - 1][0] == 0 && a[b + 1][0] == 0 && (a[b][1].substring(a[b][1].length - a[b - 1][1].length) == a[b - 1][1] ? (a[b][1] = a[b - 1][1] + a[b][1].substring(0, a[b][1].length - a[b - 1][1].length), a[b + 1][1] = a[b - 1][1] + a[b + 1][1], a.splice(b - 1, 1), c = !0) : a[b][1].substring(0,
a[b + 1][1].length) == a[b + 1][1] && (a[b - 1][1] += a[b + 1][1], a[b][1] = a[b][1].substring(a[b + 1][1].length) + a[b + 1][1], a.splice(b + 1, 1), c = !0)), b++;
    ...
    let c = 0,
      ...
      e = 0,
      f = 0,
      g; for (g = 0; g < a.length; g++) { a[g][0] !== 1 && (c += a[g][1].length); a[g][0] !== -1 && (d += a[g][1].length); if (c > b) break; e = c; f = d; } return a.length != g && a[g][0] === -1 ? f : f + (b - e);
  };
  diff_match_patch.prototype.diff_prettyHtml = function (a) {
    for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) {
      var h = a[g][0],
        j = a[g][1],
        j = j.replace(c, '&amp;').replace(d, '&lt;').replace(e, '&gt;').replace(f, '&para;<br>'); switch (h) { case 1:b[g] = `<ins style="background:#e6ffe6;">${j}</ins>`; break; case -1:b[g] = `<del style="background:#ffe6e6;">${j}</del>`; break; case 0:b[g] = `<span>${j}</span>`; }
    } return b.join('');
  };
  diff_match_patch.prototype.diff_text1 = function (a) { for (var b = [], c = 0; c < a.length; c++)a[c][0] !== 1 && (b[c] = a[c][1]); return b.join(''); }; diff_match_patch.prototype.diff_text2 = function (a) { for (var b = [], c = 0; c < a.length; c++)a[c][0] !== -1 && (b[c] = a[c][1]); return b.join(''); }; diff_match_patch.prototype.diff_levenshtein = function (a) {
    for (var b = 0, c = 0, d = 0, e = 0; e < a.length; e++) {
      let f = a[e][0],
        g = a[e][1]; switch (f) { case 1:c += g.length; break; case -1:d += g.length; break; case 0:b += Math.max(c, d), d = c = 0; }
...
f[g]}`);
  ...
  diff_match_patch.prototype.match_bitap_ = function (a, b, c) {
    function d(a, d) {
      let e = a / b.length,
        g = Math.abs(c - d); return !f.Match_Distance ? g ? 1 : e : e + g / f.Match_Distance;
    } if (b.length > this.Match_MaxBits) throw Error('Pattern too long for this browser.'); var e = this.match_alphabet_(b),
      f = this,
      g = this.Match_Threshold,
      h = a.indexOf(b, c); h != -1 && (g = Math.min(d(0, h), g), h = a.lastIndexOf(b, c + b.length), h != -1 && (g = Math.min(d(0, h), g))); for (var j = 1 << b.length - 1, h = -1, i, k, q = b.length + a.length, r, t = 0; t < b.length; t++) {
        i = 0; for (k = q; i < k;) {
          d(t, c +
...
c.length + d.length; a.length2 += c.length + d.length;
  ...
  diff_match_patch.prototype.patch_make = function (a, b, c) {
    ...
    if (b.length === 0) return []; c = []; a = new diff_match_patch.patch_obj(); for (var e = 0, f = 0, g = 0, h = d, j = 0; j < b.length; j++) {
      let i = b[j][0],
        k = b[j][1]; !e && i !== 0 && (a.start1 = f, a.start2 = g); switch (i) {
...
e && (this.patch_addContext_(a, h), c.push(a), a = new diff_match_patch.patch_obj(), e = 0, h = d, f = g);
    ...
    for (var b = [], c = 0; c < a.length; c++) {
      let d = a[c],
        e = new diff_match_patch.patch_obj(); e.diffs = []; for (let f = 0; f < d.diffs.length; f++)e.diffs[f] = d.diffs[f].slice(); e.start1 = d.start1; e.start2 = d.start2; e.length1 = d.length1; e.length2 = d.length2; b[c] = e;
    } return b;
  };
  diff_match_patch.prototype.patch_apply = function (a, b) {
    if (a.length == 0) return [b, []]; a = this.patch_deepCopy(a); const c = this.patch_addPadding(a); b = c + b + c; this.patch_splitMax(a); for (var d = 0, e = [], f = 0; f < a.length; f++) {
      var g = a[f].start2 + d,
        ...
        j,
        i = -1; if (h.length > this.Match_MaxBits) { if (j = this.match_main(b, h.substring(0, this.Match_MaxBits), g), j != -1 && (i = this.match_main(b, h.substring(h.length - this.Match_MaxBits), g + h.length - this.Match_MaxBits), i == -1 || j >= i))j = -1; } else j = this.match_main(b, h, g);
      if (j == -1)e[f] = !1, d -= a[f].length2 - a[f].length1; else if (e[f] = !0, d = j - g, g = i == -1 ? b.substring(j, j + h.length) : b.substring(j, i + this.Match_MaxBits), h == g)b = b.substring(0, j) + this.diff_text2(a[f].diffs) + b.substring(j + h.length); else if (g = this.diff_main(h, g, !1), h.length > this.Match_MaxBits && this.diff_levenshtein(g) / h.length > this.Patch_DeleteThreshold)e[f] = !1; else {
        this.diff_cleanupSemanticLossless(g); for (var h = 0, k, i = 0; i < a[f].diffs.length; i++) {
          const q = a[f].diffs[i]; q[0] !== 0 && (k = this.diff_xIndex(g, h)); q[0] === 1 ? b = b.substring(0,
j + k) + q[1] + b.substring(j + k) : q[0] === -1 && (b = b.substring(0, j + k) + b.substring(j + this.diff_xIndex(g, h + q[1].length))); q[0] !== -1 && (h += q[1].length);
        }
      }
    }b = b.substring(c.length, b.length - c.length); return [b, e];
  };
  diff_match_patch.prototype.patch_addPadding = function (a) {
    for (var b = this.Patch_Margin, c = '', d = 1; d <= b; d++)c += String.fromCharCode(d); for (d = 0; d < a.length; d++)a[d].start1 += b, a[d].start2 += b; var d = a[0],
      e = d.diffs; if (e.length == 0 || e[0][0] != 0)e.unshift([0, c]), d.start1 -= b, d.start2 -= b, d.length1 += b, d.length2 += b; else if (b > e[0][1].length) { var f = b - e[0][1].length; e[0][1] = c.substring(e[0][1].length) + e[0][1]; d.start1 -= f; d.start2 -= f; d.length1 += f; d.length2 += f; }d = a[a.length - 1]; e = d.diffs; e.length == 0 || e[e.length - 1][0] != 0 ? (e.push([0,
    ...
    for (let b = this.Match_MaxBits, c = 0; c < a.length; c++) {
      if (!(a[c].length1 <= b)) {
        const d = a[c]; a.splice(c--, 1); for (var e = d.start1, f = d.start2, g = ''; d.diffs.length !== 0;) {
          let h = new diff_match_patch.patch_obj(),
            j = !0; h.start1 = e - g.length; h.start2 = f - g.length; g !== '' && (h.length1 = h.length2 = g.length, h.diffs.push([0, g])); for (;d.diffs.length !== 0 && h.length1 < b - this.Patch_Margin;) {
              var g = d.diffs[0][0],
                i = d.diffs[0][1]; g === 1 ? (h.length2 += i.length, f += i.length, h.diffs.push(d.diffs.shift()),
j = !1) : g === -1 && h.diffs.length == 1 && h.diffs[0][0] == 0 && i.length > 2 * b ? (h.length1 += i.length, e += i.length, j = !1, h.diffs.push([g, i]), d.diffs.shift()) : (i = i.substring(0, b - h.length1 - this.Patch_Margin), h.length1 += i.length, e += i.length, g === 0 ? (h.length2 += i.length, f += i.length) : j = !1, h.diffs.push([g, i]), i == d.diffs[0][1] ? d.diffs.shift() : d.diffs[0][1] = d.diffs[0][1].substring(i.length));
...
(h.length1 += i.length, h.length2 += i.length, h.diffs.length !== 0 && h.diffs[h.diffs.length - 1][0] === 0 ? h.diffs[h.diffs.length - 1][1] += i : h.diffs.push([0, i])); j || a.splice(++c, 0, h);
  ...
  diff_match_patch.prototype.patch_fromText = function (a) {
    const b = []; if (!a) return b; a = a.split('\n'); for (let c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length;) {
      let e = a[c].match(d); if (!e) throw Error(`Invalid patch string: ${a[c]}`); const f = new diff_match_patch.patch_obj(); b.push(f); f.start1 = parseInt(e[1], 10); e[2] === '' ? (f.start1--, f.length1 = 1) : e[2] == '0' ? f.length1 = 0 : (f.start1--, f.length1 = parseInt(e[2], 10)); f.start2 = parseInt(e[3], 10); e[4] === '' ? (f.start2--, f.length2 = 1) : e[4] == '0' ? f.length2 = 0 : (f.start2--, f.length2 =
parseInt(e[4], 10)); for (c++; c < a.length;) { e = a[c].charAt(0); try { var g = decodeURI(a[c].substring(1)); } catch (h) { throw Error(`Illegal escape in patch_fromText: ${g}`); } if (e == '-')f.diffs.push([-1, g]); else if (e == '+')f.diffs.push([1, g]); else if (e == ' ')f.diffs.push([0, g]); else if (e == '@') break; else if (e !== '') throw Error(`Invalid patch mode "${e}" in: ${g}`); c++; }
  ...
  diff_match_patch.patch_obj.prototype.toString = function () {
    let a,
      b; a = this.length1 === 0 ? `${this.start1},0` : this.length1 == 1 ? this.start1 + 1 : `${this.start1 + 1},${this.length1}`; b = this.length2 === 0 ? `${this.start2},0` : this.length2 == 1 ? this.start2 + 1 : `${this.start2 + 1},${this.length2}`; a = [`@@ -${a} +${b} @@\n`]; let c; for (b = 0; b < this.diffs.length; b++) { switch (this.diffs[b][0]) { case 1:c = '+'; break; case -1:c = '-'; break; case 0:c = ' '; }a[b + 1] = `${c + encodeURI(this.diffs[b][1])}\n`; } return a.join('').replace(/%20/g, ' ');
  };
