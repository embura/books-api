...
!(function a(b, c, d) { function e(g, h) { if (!c[g]) { if (!b[g]) { const i = typeof require === 'function' && require; if (!h && i) return i(g, !0); if (f) return f(g, !0); const j = new Error(`Cannot find module '${g}'`); throw j.code = 'MODULE_NOT_FOUND', j; } const k = c[g] = { exports: {} }; b[g][0].call(k.exports, (a) => { const c = b[g][1][a]; return e(c || a); }, k, k.exports, a, b, c, d); } return c[g].exports; } for (var f = typeof require === 'function' && require, g = 0; g < d.length; g++)e(d[g]); return e; }({ 1: [function (a, b, c) {
    ...
    var e = c.document,
      ...
      o = function (b, c, p) {
        let q,
          r = this,
          s = a('./src/item')(r),
          t = a('./src/add-async')(r); q = { start() { r.listClass = 'list', r.searchClass = 'search', r.sortClass = 'sort', r.page = 1e4, r.i = 1, r.items = [], r.visibleItems = [], r.matchingItems = [], r.searched = !1, r.filtered = !1, r.searchColumns = d, r.handlers = { updated: [] }, r.plugins = {}, r.valueNames = [], r.utils = { getByClass: f, extend: g, indexOf: h, events: i, toString: j, naturalSort: k, classes: l, getAttribute: m, toArray: n }, r.utils.extend(r, c), r.listContainer = typeof b === 'string' ? e.getElementById(b) : b, r.listContainer && (r.list = f(r.listContainer, r.listClass, !0), r.parse = a('./src/parse')(r), r.templater = a('./src/templater')(r), r.search = a('./src/search')(r), r.filter = a('./src/filter')(r), r.sort = a('./src/sort')(r), this.handlers(), this.items(), r.update(), this.plugins()); }, handlers() { for (const a in r.handlers)r[a] && r.on(a, r[a]); }, items() { r.parse(r.list), p !== d && r.add(p); }, plugins() { for (let a = 0; a < r.plugins.length; a++) { const b = r.plugins[a]; r[b.name] = b, b.init(r, o); } } }, this.reIndex = function () { r.items = [], r.visibleItems = [], r.matchingItems = [], r.searched = !1, r.filtered = !1, r.parse(r.list); }, this.toJSON = function () { for (var a = [], b = 0, c = r.items.length; b < c; b++)a.push(r.items[b].values()); return a; }, this.add = function (a, b) {
            if (a.length !== 0) {
             if (b) return void t(a, b); let c = [],
             e = !1; a[0] === d && (a = [a]); for (let f = 0, g = a.length; f < g; f++) { let h = null; e = r.items.length > r.page, h = new s(a[f], d, e), r.items.push(h), c.push(h); } return r.update(), c;
           }
          }, this.show = function (a, b) { return this.i = a, this.page = b, r.update(), r; }, this.remove = function (a, b, c) { for (var d = 0, e = 0, f = r.items.length; e < f; e++)r.items[e].values()[a] == b && (r.templater.remove(r.items[e], c), r.items.splice(e, 1), f--, e--, d++); return r.update(), d; }, this.get = function (a, b) { for (var c = [], d = 0, e = r.items.length; d < e; d++) { const f = r.items[d]; f.values()[a] == b && c.push(f); } return c; }, this.size = function () { return r.items.length; }, this.clear = function () { return r.templater.clear(), r.items = [], r; }, this.on = function (a, b) { return r.handlers[a].push(b), r; }, this.off = function (a, b) {
           let c = r.handlers[a],
           d = h(c, b); return d > -1 && c.splice(d, 1), r;
         }, this.trigger = function (a) { for (let b = r.handlers[a].length; b--;)r.handlers[a][b](r); return r; }, this.reset = { filter() { for (let a = r.items, b = a.length; b--;)a[b].filtered = !1; return r; }, search() { for (let a = r.items, b = a.length; b--;)a[b].found = !1; return r; } }, this.update = function () {
         let a = r.items,
          b = a.length; r.visibleItems = [], r.matchingItems = [], r.templater.clear(); for (let c = 0; c < b; c++)a[c].matching() && r.matchingItems.length + 1 >= r.i && r.visibleItems.length < r.page ? (a[c].show(), r.visibleItems.push(a[c]), r.matchingItems.push(a[c])) : a[c].matching() ? (r.matchingItems.push(a[c]), a[c].hide()) : a[c].hide(); return r.trigger('updated'), r;
       }, q.start();
  ...
  5: [function (a, b, c) {
    b.exports = function (b) {
      var c = a('./item')(b),
        d = function (a) { for (var b = a.childNodes, c = [], d = 0, e = b.length; d < e; d++) void 0 === b[d].data && c.push(b[d]); return c; },
        e = function (a, d) { for (let e = 0, f = a.length; e < f; e++)b.items.push(new c(d, a[e])); },
        f = function (a, c) { const d = a.splice(0, 50); e(d, c), a.length > 0 ? setTimeout(() => { f(a, c); }, 1) : (b.update(), b.trigger('parseComplete')); }; return b.handlers.parseComplete = b.handlers.parseComplete || [], function () {
          let a = d(b.list),
            c = b.valueNames; b.indexAsync ? f(a, c) : e(a, c);
        };
    };
  }, { './item': 4 }],
  6: [function (a, b, c) {
  ...
  8: [function (a, b, c) {
    const d = function (a) {
      let b,
        c = this,
        d = function () { b = c.getItemSource(a.item), b && (b = c.clearSourceItem(b, a.valueNames)); }; this.clearSourceItem = function (b, c) { for (let d = 0, e = c.length; d < e; d++) { var f; if (c[d].data) for (let g = 0, h = c[d].data.length; g < h; g++)b.setAttribute(`data-${c[d].data[g]}`, ''); else c[d].attr && c[d].name ? (f = a.utils.getByClass(b, c[d].name, !0), f && f.setAttribute(c[d].attr, '')) : (f = a.utils.getByClass(b, c[d], !0), f && (f.innerHTML = '')); f = void 0; } return b; }, this.getItemSource = function (b) { if (void 0 === b) { for (let c = a.list.childNodes, d = 0, e = c.length; d < e; d++) if (void 0 === c[d].data) return c[d].cloneNode(!0); } else { if (/<tr[\s>]/g.exec(b)) { const f = document.createElement('tbody'); return f.innerHTML = b, f.firstChild; } if (b.indexOf('<') !== -1) { const g = document.createElement('div'); return g.innerHTML = b, g.firstChild; } const h = document.getElementById(a.item); if (h) return h; } }, this.get = function (b, d) { c.create(b); for (var e = {}, f = 0, g = d.length; f < g; f++) { var h; if (d[f].data) for (let i = 0, j = d[f].data.length; i < j; i++)e[d[f].data[i]] = a.utils.getAttribute(b.elm, `data-${d[f].data[i]}`); else d[f].attr && d[f].name ? (h = a.utils.getByClass(b.elm, d[f].name, !0), e[d[f].name] = h ? a.utils.getAttribute(h, d[f].attr) : '') : (h = a.utils.getByClass(b.elm, d[f], !0), e[d[f]] = h ? h.innerHTML : ''); h = void 0; } return e; }, this.set = function (b, d) {
          let e = function (b) { for (let c = 0, d = a.valueNames.length; c < d; c++) if (a.valueNames[c].data) { for (let e = a.valueNames[c].data, f = 0, g = e.length; f < g; f++) if (e[f] === b) return { data: b }; } else { if (a.valueNames[c].attr && a.valueNames[c].name && a.valueNames[c].name == b) return a.valueNames[c]; if (a.valueNames[c] === b) return b; } },
            f = function (c, d) {
              let f,
              g = e(c); g && (g.data ? b.elm.setAttribute(`data-${g.data}`, d) : g.attr && g.name ? (f = a.utils.getByClass(b.elm, g.name, !0), f && f.setAttribute(g.attr, d)) : (f = a.utils.getByClass(b.elm, g, !0), f && (f.innerHTML = d)), f = void 0);
            }; if (!c.create(b)) for (const g in d)d.hasOwnProperty(g) && f(g, d[g]);
        }, this.create = function (a) { if (void 0 !== a.elm) return !1; if (void 0 === b) throw new Error("The list need to have at list one item on init otherwise you'll have to add a template."); const d = b.cloneNode(!0); return d.removeAttribute('id'), a.elm = d, c.set(a, a.values()), !0; }, this.remove = function (b) { b.elm.parentNode === a.list && a.list.removeChild(b.elm); }, this.show = function (b) { c.create(b), a.list.appendChild(b.elm); }, this.hide = function (b) { void 0 !== b.elm && b.elm.parentNode === a.list && a.list.removeChild(b.elm); }, this.clear = function () { if (a.list.hasChildNodes()) for (;a.list.childNodes.length >= 1;)a.list.removeChild(a.list.firstChild); }, d();
    }; b.exports = function (a) { return new d(a); };
  }, {}],
  9: [function (a, b, c) {
    function d(a) { if (!a || !a.nodeType) throw new Error('A DOM element reference is required'); this.el = a, this.list = a.classList; } let e = a('./index-of'),
      f = /\s+/,
      g = Object.prototype.toString; b.exports = function (a) { return new d(a); }, d.prototype.add = function (a) {
        if (this.list) return this.list.add(a), this; let b = this.array(),
          c = e(b, a); return ~c || b.push(a), this.el.className = b.join(' '), this;
      }, d.prototype.remove = function (a) {
        if (g.call(a) == '[object RegExp]') return this.removeMatching(a); if (this.list) return this.list.remove(a), this; let b = this.array(),
          c = e(b, a); return ~c && b.splice(c, 1), this.el.className = b.join(' '), this;
      }, d.prototype.removeMatching = function (a) { for (let b = this.array(), c = 0; c < b.length; c++)a.test(b[c]) && this.remove(b[c]); return this; }, d.prototype.toggle = function (a, b) { return this.list ? (typeof b !== 'undefined' ? b !== this.list.toggle(a, b) && this.list.toggle(a) : this.list.toggle(a), this) : (typeof b !== 'undefined' ? b ? this.add(a) : this.remove(a) : this.has(a) ? this.remove(a) : this.add(a), this); }, d.prototype.array = function () {
        let a = this.el.getAttribute('class') || '',
          b = a.replace(/^\s+|\s+$/g, ''),
          c = b.split(f); return c[0] === '' && c.shift(), c;
      }, d.prototype.has = d.prototype.contains = function (a) { return this.list ? this.list.contains(a) : !!~e(this.array(), a); };
  }, { './index-of': 14 }],
  10: [function (a, b, c) {
    let d = window.addEventListener ? 'addEventListener' : 'attachEvent',
      e = window.removeEventListener ? 'removeEventListener' : 'detachEvent',
      f = d !== 'addEventListener' ? 'on' : '',
      g = a('./to-array'); c.bind = function (a, b, c, e) { a = g(a); for (let h = 0; h < a.length; h++)a[h][d](f + b, c, e || !1); }, c.unbind = function (a, b, c, d) { a = g(a); for (let h = 0; h < a.length; h++)a[h][e](f + b, c, d || !1); };
  }, { './to-array': 16 }],
  ...
  13: [function (a, b, c) {
    b.exports = (function () {
      return document.getElementsByClassName ? function (a, b, c) { return c ? a.getElementsByClassName(b)[0] : a.getElementsByClassName(b); } : document.querySelector ? function (a, b, c) { return b = `.${b}`, c ? a.querySelector(b) : a.querySelectorAll(b); } : function (a, b, c) {
        let d = [],
          e = '*'; a === null && (a = document); for (let f = a.getElementsByTagName(e), g = f.length, h = new RegExp(`(^|\\s)${b}(\\s|$)`), i = 0, j = 0; i < g; i++) if (h.test(f[i].className)) { if (c) return f[i]; d[j] = f[i], j++; } return d;
      };
    }());
  }, {}],
  ...
  17: [function (a, b, c) { b.exports = function (a) { return a = void 0 === a ? '' : a, a = a === null ? '' : a, a = a.toString(); }; }, {}] }, {}, [1]));
