...
n, b, f) {
      let l,
        ...
        m = a,
        q = !0,
        A = ''; a || (q = !1, a = `_@r${R += 1}`); a = e(a); z = a[0]; a = a[1]; z && (z = c(z, k, f), d = g(r, z)); a && (z ? A = d && d.normalize ? d.normalize(a, a => c(a, k, f)) : a.indexOf('!') === -1 ? c(a, k, f) : a : (A = c(a, k, f), a = e(A), z = a[0], A = a[1], b = !0, l = h.nameToUrl(A))); b = !z || d || b ? '' : `_unnormalized${U += 1}`; return { prefix: z, name: A, parentMap: n, unnormalized: !!b, url: l, originalName: m, isDefine: q, id: (z ? `${z}!${A}` : A) + b };
    } function u(a) {
      let b = a.id,
...
b, c) {
     ...
     let c = a.requireModules,
      f = !1; if (b)b(a); else if (x(c, (b) => { if (b = g(t, b))b.error = a, b.events.error && (f = !0, b.emit('error', a)); }), !f)k.onError(a);
   } function C() { W.length && (x(W, (a) => { const b = a[0]; typeof b === 'string' && (h.defQueueMap[b] = !0); H.push(a); }), W = []); } function D(a) { delete t[a]; delete aa[a]; } function K(a, b, c) {
    const f = a.map.id; a.error ? a.emit('error',
a.error) : (b[f] = !0, x(a.depMaps, (f, d) => {
  let h = f.id,
...
`Load timeout for modules: ${f}`, null, f), a.contextName = h.contextName, B(a);
    ...
    function Q() { let a; for (C(); H.length;) { a = H.shift(); if (a[0] === null) return B(G('mismatch', `Mismatched anonymous define() module: ${a[a.length - 1]}`)); J(a); }h.defQueueMap = {}; } var ba,
      ea,
      h,
      S,
      ca,
      ...
      ga = {},
      R = 1,
      U = 1; S = { require(a) { return a.require ? a.require : a.require = h.makeRequire(a.map); },
        exports(a) {
...
{};
        ...
        module(a) { return a.module ? a.module : a.module = { id: a.map.id, uri: a.map.url, config() { return g(m.config, a.map.id) || {}; }, exports: a.exports || (a.exports = {}) }; } }; ea = function (a) { this.events = g(fa, a.id) || {}; this.map = a; this.shim = g(m.shim, a.id); this.depExports = []; this.depMaps = []; this.depMatched = []; this.pluginMaps = {}; this.depCount = 0; }; ea.prototype = { init(a, b, c, f) {
          f = f || {}; if (!this.inited) {
...
this.callPlugin() : this.load();
          ...
          check() {
            if (this.enabled && !this.enabling) {
              let a,
               b,
               c = this.map.id; b = this.depExports; let f = this.exports,
...
y(this, function (a, b) {
  let c,
    f; if (typeof a === 'string') { a = q(a, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap); this.depMaps[b] = a; if (c = g(S, a.id)) { this.depExports[b] = c(this); return; } this.depCount += 1; v(a, 'defined', y(this, function (a) { this.undefed || (this.defineDep(b, a), this.check()); })); this.errback ? v(a, 'error', y(this, this.errback)) : this.events.error && v(a, 'error', y(this, function (a) { this.emit('error', a); })); }c = a.id; f = t[c]; w(S, c) || !f || f.enabled || h.enable(a, this);
...
g(t, a.id); b && !b.enabled && h.enable(a, this);
          ...
          emit(a, b) { x(this.events[a], (a) => { a(b); }); a === 'error' && delete this.events[a]; } }; h = { config: m,
            contextName: b,
            registry: t,
            defined: r,
            urlFetched: X,
            ...
            onError: B,
            configure(a) {
              a.baseUrl && a.baseUrl.charAt(a.baseUrl.length - 1) !== '/' && (a.baseUrl += '/'); let b = m.shim,
               c = { paths: !0,
                bundles: !0,
                config: !0,
                map: !0 }; E(a, (a, b) => { c[b] ? (m[b] || (m[b] = {}), Z(m[b], a, !0, !0)) : m[b] = a; }); a.bundles && E(a.bundles, (a, b) => { x(a, (a) => { a !== b && (ga[a] = b); }); }); a.shim && (E(a.shim, (a, c) => { M(a) && (a = { deps: a }); !a.exports && !a.init || a.exportsFn || (a.exportsFn = h.makeShimExports(a)); b[c] = a; }), m.shim = b); a.packages && x(a.packages, (a) => { let b; a = typeof a === 'string' ? { name: a } : a; b = a.name; a.location && (m.paths[b] = a.location); m.pkgs[b] = `${a.name}/${(a.main || 'main').replace(na, '').replace(V, '')}`; }); E(t,
(a, b) => { a.inited || a.map.unnormalized || (a.map = q(b, null, !0)); }); (a.deps || a.callback) && h.require(a.deps || [], a.callback);
            ...
            makeRequire(a, n) {
              function e(c, d, g) {
               let m,
                p; n.enableBuildCallback && d && L(d) && (d.__requireJsBuild = !0); if (typeof c === 'string') {
...
q(b, a, !1, !0).id);
              ...
              specified(b) { b = q(b, a, !1, !0).id; return w(r, b) || w(t, b); } }); a || (e.undef = function (b) {
                C(); let c = q(b, a, !0),
                  e = g(t, b); e.undefed = !0; d(b); delete r[b]; delete X[c.url]; delete fa[b]; Y(H, (a, c) => { a[0] === b && H.splice(c, 1); }); delete h.defQueueMap[b]; e && (e.events.defined && (fa[b] = e.events), D(b));
              }); return e;
            },
...
a && (b = !0);
            ...
            nameToUrl(a, b, c) {
              let d,
               e,
               p; (d = g(m.pkgs, a)) && (a = d); if (d = g(ga, a)) return h.nameToUrl(d, b, c); if (k.jsExtRegExp.test(a))d = a + (b || ''); else {
...
c ? '' : '.js'); d = (d.charAt(0) === '/' || d.match(/^[\w\+\.\-]+:/) ? '' : m.baseUrl) + d;
  ...
  } function pa() { if (O && O.readyState === 'interactive') return O; Y(document.getElementsByTagName('script'), (b) => { if (b.readyState === 'interactive') return O = b; }); return O; } var k,
    C,
    D,
    I,
    P,
...
c, d, p) {
        ...
        }; k.config = function (b) { return k(b); }; k.nextTick = typeof setTimeout !== 'undefined' ? function (b) { setTimeout(b, 4); } : function (b) { b(); }; require || (require = k); k.version = '2.1.22'; k.jsExtRegExp = /^\/|:|\?|\.js$/; k.isBrowser = F; C = k.s = { contexts: K, newContext: ma }; k({}); x(['toUrl', 'undef', 'defined', 'specified'], (b) => {
          k[b] = function () {
           const c =
...
c} at ${d}`, q, [c]));
        ...
        let g,
          e; typeof b !== 'string' && (d = c, c = b, b = null); M(c) || (d = c, c = null); !c && L(d) && (c = [], d.length && (d.toString().replace(qa, '').replace(ra, (b, d) => { c.push(d); }),
